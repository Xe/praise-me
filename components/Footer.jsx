const navigation = [
  // {
  //   name: "Instagram",
  //   href: "https://instagram.com/cadeyratio",
  //   icon: (props) => (
  ...
  // {
  //   name: "X",
  //   href: "https://twitter.com/theprincessxena",
  //   icon: (props) => (
  //     <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div class="mt-8 md:order-1 md:mt-0">
          ...
          <p class="mt-4">
            Poke{" "}
            <a
              class="text-blue-400 dark:text-blue-700 underline"
              href="https://x.com/theprincessxena"
            >
              @theprincessxena
            </a>{" "}
            if something goes wrong. If you want, you can{" "}
            <a
              href="/delete"
