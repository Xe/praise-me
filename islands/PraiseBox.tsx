            ...
            <div className="max-w-2xl">
                ...
                {loading
                            ...
                            {praiseMessage !== null
                                ...
                                : (
                                    <>
                                        ...
                                        <p class="pb-4">
                                            This may take a moment, Mimi (the
                                            chatbot powering this thing) may
                                            have taken a cat nap and you may
                                            need to wait for her model weights
                                            to load. Just have patience and
                    ...
                    : (
                        <>
                            <p class="pb-4">
                                Instead of trying to tear eachother down with
                                AI, why not use it to help lift others up?
                            </p>
                            <div class="mb-4">
                                <input
                                    type="text"
